...
```bash
AUDITOR_MODEL=$(node "/Users/stephen/Projects/202604/ocrv1/.opencode/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read /Users/stephen/Projects/202604/ocrv1/.opencode/agents/gsd-eval-auditor.md for instructions.
