...
```bash
AUDITOR_MODEL=$(node "/Users/stephen/Projects/202604/ocrv1/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read /Users/stephen/Projects/202604/ocrv1/.claude/agents/gsd-eval-auditor.md for instructions.
