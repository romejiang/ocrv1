...
Intel system is disabled. To activate:
  ...
  node /Users/stephen/Projects/202604/ocrv1/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /Users/stephen/Projects/202604/ocrv1/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /Users/stephen/Projects/202604/ocrv1/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /Users/stephen/Projects/202604/ocrv1/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
