...
<required_reading>
@/Users/stephen/Projects/202604/ocrv1/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/stephen/Projects/202604/ocrv1/.claude
                  → checks /Users/stephen/Projects/202604/ocrv1/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/stephen/Projects/202604/ocrv1/.claude/get-shit-done
                  → writes to /Users/stephen/Projects/202604/ocrv1/.claude/get-shit-done/hooks/
...
@/Users/stephen/Projects/202604/ocrv1/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/stephen/Projects/202604/ocrv1/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/stephen/Projects/202604/ocrv1/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/stephen/Projects/202604/ocrv1/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/stephen/Projects/202604/ocrv1/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
